...
(function(){
  ...
  function homeButton(){
    ...
    const b=document.createElement('button');b.type='button';b.dataset.rafHome='1';b.className='secondary';b.textContent='⌂ Home';b.style.cssText='margin-left:12px;white-space:nowrap;';top.appendChild(b);
  }
